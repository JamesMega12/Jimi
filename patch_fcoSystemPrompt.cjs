...
// Replace the end part starting from TASK
const taskMarker = 'TASK\nWhen the user provides raw FCO content';
const splitIndex = content.indexOf(taskMarker);
...
const baseContent = content.substring(0, splitIndex);
...
const dynamicContent = `
  ...
  return \`${baseContent}\${packContent}
...
content = baseContent + dynamicContent;
